...
<head>
    ...
    <title>Foodie. - Super delicious Burger in town</title>
        ...
        <article>
            ...
            <section class="hero" id="home" style="background-image: url('./assets/images/hero-bg.jpg')">
                <div class="container">
                    <div class="hero-content">
                        ...
                        <h2 class="h1 hero-title">Supper delicious Burger in town!
                        </h2>

                        <p class="hero-text">
                            “Embark on a Culinary Odyssey: Where Every Bite Tells a Flavorful Tale!”

                            Feel free to sprinkle explore across our website, enticing our customers to
                            explore the delightful world of Foodie. Bon appétit! 🍽️🌟
                        </p>
                    ...
                    <figure class="hero-banner">
                        <img src="./assets/images/hero-banner-bg.png" width="820" height="716" loading="lazy" alt=""
                    ...
                    <ul class="promo-list has-scrollbar">
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Maxican Pizza
                                </h3>
                                <p class="card-text">
                                    Mexican Pizza is a delicious fusion dish that combines elements of Mexican and
                                    Italian cuisine It’s often garnished with traditional Mexican toppings such as
                                    tomatoes, onions, olives, and jalapenos. This dish is known for its rich flavors and
                                    satisfying textures. Enjoy! 😊
                                </p>

                                <img src="./assets/images/promo-1.png" width="300" height="300" loading="lazy"
                                    alt="Maxican Pizza" class="w-100 card-banner">
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Soft Drinks
                                </h3>
                                <p class="card-text">
                                    Mexican Pizza pairs well with a variety of soft drinks, especially those that can
                                    balance the rich and spicy flavors of the pizza. Here are some popular choices:
                                    Jarritos,Mexican Coke,Mundet’s Apple Soda.
                                    Remember, the best drink to pair with your meal ultimately depends on your personal
                                    preference. Enjoy your Mexican Pizza! 😊
                                </p>
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">French Fries
                                </h3>
                                <p class="card-text">
                                    French Fries Golden, crispy potato sticks seasoned with salt. Perfectly fried to a
                                    delightful crunch. Served with ketchup or your choice of dipping sauce.

                                    Enjoy this classic side dish! 🍟😊
                                </p>

                                <img src="./assets/images/promo-3.png" width="300" height="300" loading="lazy"
                                    alt="French Fries" class="w-100 card-banner">
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Burger Kingo
                                </h3>
                                <p class="card-text">
                                    Indulge in the grandeur of our King Size Burger, featuring a double-layer of
                                    succulent beef patties, crowned with a generous helping of melted artisanal cheeses.
                                    Nestled between a gourmet brioche bun, it’s garnished with crisp lettuce, heirloom
                                    tomatoes, caramelized onions, and our signature royal sauce. Fit for a king!👑🍔
                                </p>

                                <img src="./assets/images/promo-4.png" width="300" height="300" loading="lazy"
                                    alt="Burger Kingo" class="w-100 card-banner">
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Steamed Momos

                                </h3>
                                <p class="card-text">
                                    Delight in our handcrafted momos, a beloved Himalayan dumpling, filled with a choice
                                    of tender meats or seasoned vegetables, wrapped in a delicate flour shell, and
                                    steamed to perfection. Dip into our special spicy sauce for an extra kick!🥟
                                </p>

                                <img src="./assets/images/promo-5.png" width="300" height="300" loading="lazy"
                                    alt="Steamed Momos" class="w-100 card-banner">
                        ...
                        <li class="promo-item">
                            <div class="promo-card">
                                ...
                                <h3 class="h3 card-title">Spaghetti

                                </h3>
                                <p class="card-text">
                                    Indulge in the classic comfort of Spaghetti - twirlable, tender strands of pasta
                                    drenched in a rich, savory sauce, garnished with a sprinkle of fresh herbs and a
                                    generous dusting of Parmesan cheese. A timeless dish that promises to delight your
                                    taste buds with every forkful! 🍝✨
                                </p>

                                <img src="./assets/images/promo-6.png" width="300" height="300" loading="lazy"
                                    alt="Spaghetti" class="w-100 card-banner">
            ...
            <section class="section section-divider gray about" id="about">
                <div class="container">
                    <div class="about-banner">
                        <img src="./assets/images/about-banner.png" width="509" height="459" loading="lazy"
                            alt="Burger with Drinks" class="w-100 about-img">

                        <img src="./assets/images/sale-shape-red.png" width="216" height="226" loading="lazy"
                            alt="get up to 50% off now" class="abs-img scale-up-anim">
                    </div>
                    <div class="about-content">
                        <h2 class="h2 section-title">
                            Foodie, Burgers, and Best Pizzas <span class="span">in Town! </span>
                        </h2>
                        <p class="section-text">
                            With a diverse selection of delicious dishes ranging from Mexican pizza to crispy French
                            fries, Foodie promises to satisfy your cravings with convenience and style.
                        ...
                        <ul class="about-list">
                            <li class="about-item">
                                ...
                                <span class="span">Delicious & Healthy Foods
                                </span>
                            ...
                            <li class="about-item">
                                ...
                                <span class="span">Specific Family And Kids Zone
                            ...
                            <li class="about-item">
                                ...
                                <span class="span">Music & Other Facilities
                            ...
                            <li class="about-item">
                                ...
                                <span class="span">Fastest Food Home Delivery
                                </span>
                        ...
                        <button class="btn btn-hover">Order Now
                        </button>
                    </div>
                </div>
            </section>
            ...
            <section class="section white food-menu" id="food-menu">
                <div class="container">
                    ...
                    <p class="section-subtitle">Popular Dishes
                    </p>

                    <h2 class="h2 section-title">Our Delicious <span class="span">Foods</span>

                    </h2>

                    <p class="section-text">
                        We have different categories of food and cuisine listed below from 5 star rated restaurants
                        around the world.
                    ...
                    <ul class="food-menu-list">
                        ...
                        <li>
                            <div class="food-menu-card">
                                ...
                                <h3 class="h3 card-title">Fried Chicken Unlimited
                                </h3>
                                ...
                                <div class="price-wrap">
                                    ...
                                    <data class="price" value="49.00">$49.00
                                    </data>
                        ...
                        <li>
                            <div class="food-menu-card">
                                ...
                                <h3 class="h3 card-title">Burger King Whopper
                                </h3>
                                ...
                                <div class="price-wrap">
                                    ...
                                    <data class="price" value="29.00">$29.00
                                    </data>
                        ...
                        <li>
                            <div class="food-menu-card">
                                ...
                                <h3 class="h3 card-title">White Castle Pizzas
                                </h3>
                        ...
                        <li>
                            <div class="food-menu-card">
                                ...
                                <h3 class="h3 card-title">Bell Burrito Supreme
                                </h3>
                                ...
                                <div class="price-wrap">
                                    ...
                                    <data class="price" value="59.00">$59.00
                                    </data>
                        ...
                        <li>
                            <div class="food-menu-card">
                                ...
                                <h3 class="h3 card-title">Kung Pao Chicken BBQ
                                </h3>
                        ...
                        <li>
                            <div class="food-menu-card">
                                ...
                                <h3 class="h3 card-title">Wendy's Chicken
                                </h3>
            ...
            <section class="section section-divider white cta"
                ...
                <div class="container">
                    ...
                    <div class="cta-content">
                        ...
                        <h2 class="h2 section-title">
                            The Foodie Have Excellent <span class="span">Quality Burgers!</span>
                        </h2>

                        <p class="section-text">
                            We bring you the most famous as well as fresh and tasty food and diffrent cuisines from
                            around the diffrent parts of the world
                            If you are a foodie and like eating food from around the world from one of the best
                            restaurants delivered at your home then look no further
                            order now your favourite choice cuisine from our menu card in foodie.
                    ...
                    <figure class="cta-banner">
                        ...
                        <img src="./assets/images/sale-shape.png" width="216" height="226" loading="lazy" alt=""
            ...
            <section class="section section-divider gray delivery">
                <div class="container">
                    ...
                    <div class="delivery-content">
                        ...
                        <p class="section-text">
                            Gourmet Delights, Delivered Nightly - Experience the Elegance of Fine Dining at Your
                            Doorstep!
                            Delivering from a highly rated restaurant at doorsteps
                            “Savor the Stars at Your Doorstep - Premier Dishes Delivered with Care!”
                        </p>
            ...
            <section class="section section-divider white testi">
                <div class="container">
                    ...
                    <p class="section-text">
                        We Repect our Customers very much and take every rating and reviews into consideration
                        Feedbacks are welcomed on what our customers liking and disliking we listen to them and try to
                        implement or improve effective immediately.
                        We Appreciate each and every review and testimonies. As there is always a room for improvement.
                        These reviews highlight both positive and negative experiences, emphasizing the importance of
                        reliable and efficient
                        food delivery services. Remember that customer feedback plays a crucial role in shaping the
                        ...
                        <li class="testi-item">
                            <div class="testi-card">
                                ...
                                <div class="profile-wrapper">
                                    ...
                                    <figure class="avatar">
                                        <img src="./assets/images/avatar-1.jpg" width="80" height="80" loading="lazy"
                                            alt="Robert William">
                                    </figure>
                        ...
                        <li class="testi-item">
                            <div class="testi-card">
                                ...
                                <div class="profile-wrapper">
                                    ...
                                    <figure class="avatar">
                                        <img src="./assets/images/avatar-2.jpg" width="80" height="80" loading="lazy"
                                            alt="Thomas Josef">
                                    </figure>
                                    ...
                                    <div>
                                        ...
                                        <p class="testi-title">CEO Getforcer</p>
                                ...
                                <blokquote class="testi-text">
                                    “Finding balance in meals is tough, but Foodie’s healthy options have been a
                                    game-changer. Fresh, flavorful, and just a
                                    few taps away. Foodie doesn’t just deliver; it caters to my well-being. It’s my
                                    pocket-sized personal chef!”
                                </blokquote>
                        ...
                        <li class="testi-item">
                            <div class="testi-card">
                                ...
                                <div class="profile-wrapper">
                                    ...
                                    <figure class="avatar">
                                        <img src="./assets/images/avatar-3.jpg" width="80" height="80" loading="lazy"
                                            alt="Charles Richard">
                                    </figure>
                                ...
                                <blokquote class="testi-text">
                                    "thank you, Foodie, for saving me from my hangry alter ego. You’re not just a food
                                    delivery service,you’re my culinary
                                    guardian angel." 🍕🥟🍔
                                </blokquote>
                    ...
                    <ul class="banner-list">
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-2.jpg" width="550" height="465" loading="lazy"
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-3.jpg" width="550" height="465" loading="lazy"
                        ...
                        <li class="banner-item banner-md">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-4.jpg" width="550" height="220" loading="lazy"
                                    alt="American Burgers" class="banner-img">
            ...
            <section class="section section-divider white blog" id="blog">
                <div class="container">
                    ...
                    <p class="section-text">
                        Imagine opening a door to a world where every cuisine is at your fingertips. That’s the first
                        click on Foodie. From the
                        sizzling spices of Indian curries to the comforting embrace of Italian pasta, your taste buds
                            ...
                            <div class="blog-card">
                                ...
                                <div class="card-banner">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <h3 class="h3">
                                            <a href="#" class="card-title">What Do You Think About Cheese Pizza
                                                Recipes</a>
                                        </h3>

                                        <p class="card-text">
                                            “Cheese Pizza: A Slice of Comfort and Flavor”
                                            A slice of classic cheese pizza is one of life’s greatest pleasures. While
                                            calling for delivery is always a treat, being
                                            able to make your own pizza recipes at home is even more satisfying. Let’s
                                            dive into the cheesy world of pizza
                                            perfection!
                                            Crafting the Perfect Dough
                                            Our pizza dough starts with warm water, about 90 to 100 degrees. Use a
                                            thermometer to check the temperature; water
                                            that’s too cold will slow down the rising time, and water that’s too hot can
                                            kill the yeast. Next, add a little bit of
                                            sugar (this won’t make it sweet; it’s just there to feed the yeast and speed
                                            up fermentation)...
                                        </p>
                            ...
                            <div class="blog-card">
                                ...
                                <div class="card-banner">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <h3 class="h3">
                                            <a href="#" class="card-title">Making Chicken Strips With New Delicious
                                                Ingridents.</a>
                                        </h3>

                                        <p class="card-text">
                                            “Reinventing the Classic: Chicken Strips with a Gourmet Twist”
                                            Unveiling the Secret Ingredients
                                            Chicken strips, the beloved staple of comfort food menus worldwide, are
                                            getting a gourmet makeover. Gone are the days of
                                            the simple breadcrumb coating; we’re introducing a symphony of new flavors
                                            that will elevate this classic dish to new
                                            heights.

                                            The Flavor Palette
                                            Imagine tender strips of chicken, marinated not just in buttermilk, but in a
                                            fusion of coconut milk and lime, infusing
                                            tropical notes that tenderize the meat to perfection. The coating? A crunchy
                                            crust made from a blend of panko
                                            breadcrumbs, finely ground almonds, and a hint of smoked paprika for that
                                            extra kick...
                                        </p>
                            ...
                            <div class="blog-card">
                                ...
                                <div class="card-banner">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <h3 class="h3">
                                            <a href="#" class="card-title">Innovative Hot Chessyraw Pasta Make Creator
                                                Fact.</a>
                                        </h3>

                                        <p class="card-text">
                                            “The Cheesyraw Revolution: Crafting Pasta with a Creative Edge”
                                            The Art of Cheesyraw Pasta
                                            Welcome to the world of Cheesyraw Pasta, where innovation meets tradition in
                                            the kitchen. Our culinary artisans are
                                            redefining the pasta-making process with a bold new concept that’s shaking
                                            up the foodie scene.

                                            The Cheesyraw Difference
                                            At the heart of Cheesyraw Pasta lies a commitment to creativity and quality.
                                            Our pasta is made with a unique blend of
                                            artisanal cheeses, infused directly into the dough, resulting in a rich,
                                            melt-in-your-mouth experience with every bite.

                                            The Secret Ingredient
                                            What sets Cheesyraw Pasta apart is our secret ingredient: a specially
                                            curated cheese powder made from a mix of aged
                                            Parmesan, sharp Cheddar, and a touch of Gorgonzola. This cheesy trio is
                                            gently dehydrated and ground into a fine powder,
                                            which is then kneaded into our signature pasta dough...
                                        </p>
            ...
            <div class="container">
                ...
                <div class="footer-brand">
                    ...
                    <p class="footer-text">
                        ...
                        Our Lovely Customers can stay connected to our socials listed below for major updates and new
                        recipes as well as rewarding discount offers
                        so we look forward into the future to grow our community with you all and stay connected.
                        Until
                        Next Time then Foodie.
                ...
                <ul class="footer-list">
                    ...
                    <li>
                        <p class="footer-list-item">+91-92220621097</p>
                    </li>

                    <li>
                        <p class="footer-list-item">Foodiedelights@247gmail.com</p>
                    </li>

                    <li>
                        <address class="footer-list-item">634 Amit TK Plaza Foodie. ,Near Lanka road south
                            BHU,Varanasi,UP,India 60961214
                        </address>
                    </li>
                ...
                <ul class="footer-list">
                    ...
                    <form action="connect.php" method="post" class="footer-form">

                        <p class="footer-list-title">Book a Table</p>

                        <div class="input-wrapper">

                            <input type="text" name="fullName"id="fullName" required placeholder="Name" aria-label="Name"
                                class="input-field">
                        ...
                        <div class="input-wrapper">
                            <select name="totalperson" aria-label="Total person" id="total person" class="input-field">
                            ...
                            <input type="date" name="bookingdate" id="bookingdate"required placeholder="Bookingdate" aria-label="Bookingdate" 
                                class="input-field">
                        </div>
                        ...
                        <input type="submit" class="btn" value='Book a Table' name = "Book a Table"></input>
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="copyright-text">
                    &copy; 2024 <a href="#" class="copyright-link">codeionyash-k</a> All Rights Reserved.
                </p>
            </div>
        </div>
